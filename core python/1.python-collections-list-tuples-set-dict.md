...
3. [Lists `[]` - Mutable, Ordered](#1️⃣-lists---mutable-ordered)
   - Syntax & Operations
   - Real-World Use Cases
   - Key Rules & Best Practices
4. [Tuples `()` - Immutable, Ordered](#2️⃣-tuples---immutable-ordered)
   - Syntax & Operations
   - Real-World Use Cases
   - Key Rules & Best Practices
5. [Sets `{}` - Mutable, Unordered, Unique](#3️⃣-sets---mutable-unordered-unique)
   - Syntax & Operations
   - Real-World Use Cases
   - Key Rules & Best Practices
6. [Dictionaries `{}` - Key-Value Pairs](#4️⃣-dictionaries---key-value-pairs)
   - Syntax & Operations
   - Real-World Use Cases
   - Key Rules & Best Practices
...
| Replace multiple | `l[1:3] = [10, 20]` ie. Remove/slice index 1 and 2 & replace, 3 exclusive | ❌ Immutable | ❌ Not possible | `d.update({"k1": 10, "k2": 20})` |
| | | | | |
| **🗑️ REMOVE ELEMENTS** | | | | |
